...
| --- | --- | --- | --- |
| Engine IPC | loopback TCP only with `RSI_ATLAS_ALLOW_LOOPBACK_TCP=1` | authenticated Unix domain socket (`script/run_engine.py --release-ipc`); no TCP release API (crit. 114) | Swift UDS client still pending; XPC control channel later |
