...
- [x] **Step 3: Implement the smallest strict models**
...
- [x] **Step 4: Add cross-representation invariant tests**
...
- [x] **Step 1: Write corpus integrity RED tests**
...
- [x] **Step 2: Build and visually inspect fixtures**
...
- [x] **Step 3: Implement the benchmark manifest contract**
...
- [x] **Step 2: Resolve candidates outside the accepted workspace lock**
...
- [x] **Step 3: Produce the SBOM/advisory delta**
...
- [x] **Step 4: Obtain and record explicit dependency approval**
...
- [x] **Step 2: Implement an echo/hash worker first**
...
- [x] **Step 3: Prove hard-kill and concurrent-run recovery**
...
- [x] **Step 1: Write RED preflight and persistence tests**
...
- [x] **Step 2: Add pinned `pypdf` worker dependency and implement bounded preflight**
...
- [x] **Step 3: Implement promotion records**
...
- [x] **Step 4: Run real PostgreSQL and adversarial recovery tests**
