...
| 3. Retrieval and research | §§16–18 | 4–8, 25–60 | Phase 3 plan drafted (dev hybrid retrieval); implementation missing | A frozen material question produces an inspectable plan, hybrid evidence packet, bounded specialist findings, deterministic calculations, exact citations, review, and an editable versioned report. |
